...
//                if(tem[5].equals("inf") | tem[5].equals("-0.000000") | tem[5].equals("0.000000") | tem[5].equals("-nan")){
    ...
    //这个方法输入小麦的region信息，得到这个region的基因,和上面的代码不一样的是，这是没有Overlap的基因的情况，要求基因必须在这个region里面，输入文件：region信息和基因信息；输出文件：基因
    public void forRegionGene_NoOverlap(String infileS1,String infileS2,String outfileS){
        try{
            String temp = null;
            String temp2 = null;
            //BufferedReader brgene2 =null;
