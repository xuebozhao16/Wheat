...
public class Ranges {
    ...
    public Ranges (Range[] ranges, String annotation) {
        this.ranges = ranges;
        this.annotation = annotation;
        this.sortByStartPosition();
    }
    
    public Ranges (List<Range> rList, String annotation) {
    ...
    /**
     * Return new Ranges object from merging two objects// 从合并的两个对象返回新的范围对象
     * @param another
     * @return 
     */
    public Ranges merge (Ranges another) {  
        ...
        Ranges r = new Ranges(rs, this.getAnnotation());
     ...
     * @return 
     */
    public Ranges getRangesByChromosome (int chromosome) {
        ...
        return new Ranges(rs, this.getAnnotation());
    }
