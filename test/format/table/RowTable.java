...
public class RowTable<T> extends TableAbstract<T> {
    /**
     * Constructs a {@link format.table.RowTable} from a file, with default delimiter of "\t"
    ...
    /**
     * Constructs a {@link format.table.RowTable} using two dimension list of custom objects
     * @param header
     * @param cells 
     */
