 ...
 * <p>
 * Due to the large size of Fastq file, it is recommended to load a small chunk of the file. //建议加载文章的一小块
 * <p>
 * The beginning of a Fastq file generally has lower quality, it is recommended to skip the first 100,000 reads //Fastq 前边的质量可能不好，所以跳过100000的reads
 * @author Fei Lu
 */
public class Fastq {
    private int minStartIndex = 100000;
    private int maxReadNum = 1000000;      //1M 
    Read[] reads = null;
    int phredScale = Integer.MIN_VALUE; //int类型的边界值
